...
from .embedding import create_embeddings, EMBEDDING_INPUT_VERSION
from .vector_database import store_embeddings, create_qdrant_collection,index_is_ready
...
def ingestion(run_config: dict):
    ...
    try:
        ...
        print("Start the Ingestion process.")
